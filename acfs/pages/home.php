...
$home_fields = array();
$tab_sliders = array (
    ACFCS::fieldTab(['name' => 'home-tab-banner', 'label' => 'Banner']),
    array (
...
$tab_teams = array(
    ACFCS::fieldTab(['name' => 'home-tab-team', 'label' => 'Teams']),
    array (
    ...
    array (
        'key' => 'field_teams_bg_bottom',
        'label' => 'Background Bottom',
        'name' => 'teams_bg_bottom',
        'type' => 'image',
        'instructions' => '',
        'required' => 0,
        'conditional_logic' => 0,
    ...
    'location' => array (
        array (
            array (
                'param' => 'page',
                'operator' => '==',
                'value' => !empty($page_home->ID) ? $page_home->ID : '',
            ),
        ),
        array (
            array (
                'param' => 'page',
                'operator' => '==',
                'value' => !empty($page_home2) ? $page_home2->ID : '',
            ),
        ),
    ),
    'menu_order' => 0,
